<%@ Page Language="VB" AutoEventWireup="false" CodeFile="inquiryOrder.aspx.vb" Inherits="English_inquiryOrder" %>
...
<title>GOLDEN ARBUTUS ENTERPRISE CORP.>>Inquiry Cart</title>
...
<table width="820" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="616" valign="top" bgcolor="#BDE3FF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="images/line_2.jpg"><div class="t12_2">‧home > <a href="inquiry.aspx">Inquiry Cart</a></div></td>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><div class="t12_3">Inquiry Cart</div>
		      <div id="line_6">
			  <div id="group_1">
    ...
    <ItemStyle BackColor="#CEEAFF" HorizontalAlign="Center" />
			  ...
			  <div id="group_1">
			    <table width="500" border="1" cellpadding="1" cellspacing="1" bordercolor="#5DB1F9" class="c_3">
                  ...
                  <tr>
                    <td height="150" bgcolor="#B5DFFF"><div align="center"><font color="red">&nbsp;*&nbsp;</font>Special Comment:</div></td>
			  ...
			  <div>
			  <div align="center">
			  <asp:Button ID="BtnSave" runat="server" class="b_1" Text="Submit" />&nbsp;&nbsp;&nbsp;&nbsp;
			  <input name="Cancel" type="reset" class="b_1" id="Cancel" value="Cancel">
			  </div>
			  </div>
			  </td>
      ...
      <asp:Panel ID="show2" runat="server">
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><div class="t12_3">Inquiry Cart</div>
            <div id="line_3"><img src="images/line_4.jpg" alt="" width="510" height="1"></div>
	        <div id="line_6"><div class="c_3_1">Thank you for your Inquiry !  We will contact with you soon.</div>
	        </div>
			  </td>
          <td width="29"><img src="images/space.gif" alt="" width="29" height="20"></td>
        </tr>
