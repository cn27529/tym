...
Partial Class English_inquiry
    ...
    Function ChkData() As Boolean
        ...
        Dim i As Integer
        Dim Sql As String
        Sql = "select PublicID from Product where IsDel=false and Isonline=true and SiteID=2 and Kind=2"
    ...
    Protected Sub BtnEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnEdit.Click
        ...
        For Each Row In GridView1.Rows
            ...
            If ChkIsNumeric(TxtQ1.Text) = False Then
                Misc.AlertMsg(Page, "please input the positive integer!")
                Exit Sub
            End If
        Next
