Partial Class English_CommonWeb_TopWeb
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            SKind.Items.Add(New ListItem("All Search", ""))
            SKind.Items.Add(New ListItem("Category Search", "1"))
            SKind.Items.Add(New ListItem("Product Search", "2"))
        End If
    End Sub
    ...
    Protected Sub ImageSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageSearch.Click
        If SKeyWord.Text = "" Then
            Misc.AlertMsg(Page, "Please input the key words")
            Exit Sub
        End If
