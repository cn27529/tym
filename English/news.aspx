<%@ Page Language="VB" AutoEventWireup="false" CodeFile="news.aspx.vb" Inherits="English_news" %>
...
<head id="Head1" runat="server">
    <title>GOLDEN ARBUTUS ENTERPRISE CORP.>>news<asp:Literal ID="LitTitle" runat="server"></asp:Literal></title>
  ...
  <tr>
    ...
    <td width="616" valign="top" bgcolor="#BDE3FF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="images/line_2.jpg"><div class="t12_2">‧home > <a href="news.aspx">news</a></div></td>
    ...
    <asp:Panel ID="show1" runat="server">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
		  <div class="t12_3">news</div><div class="t12_6">news sum：<asp:Literal ID="LitCount" runat="server"></asp:Literal></div>
		  <div id="line_6">
		  <div id="group_1">
		  <table width="500" border="1" cellpadding="1" cellspacing="1" bordercolor="#5DB1F9" class="c_3">
                  <tr>
                    ...
                    <td bgcolor="#B5DFFF"><div align="center">subject</div></td>
                    <td width="100" height="30" bgcolor="#B5DFFF"><div align="center">date</div></td>
                  </tr>
