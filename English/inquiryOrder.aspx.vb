...
Partial Class English_inquiryOrder
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            While dr.Read
                CodeID.Items.Add(New ListItem(dr("TextEn").ToString, dr("CodeID")))
            End While
            dr.Close()
            CodeID6.Text = "Other"
    ...
    Protected Sub Sds_Data_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Sds_Data.Load
        ...
        If Session("OrderData") <> Nothing Then
            Dim ArrOrderData() As String = Session("OrderData").ToString.Split(",")
            Dim i As Integer
            Sql = "select PublicID,ProductName,FID4 from Product where IsDel=false and Isonline=true and SiteID=2 and Kind=2"
            For i = 0 To UBound(ArrOrderData)
                If i = 0 Then
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        If Session("R") = True Then
            Session("R") = Nothing
            Response.Write("<Script>alert('Don't refresh');location.href='product.aspx';</script>")
            Exit Sub
        End If
        '新增Inquiry
        Dim Sql As String
        Sql = "insert into Inquiry(SiteID,UserName,CompanyName,Phone,Fax,Tel,Email,Website,Content,IsRead,IsDel,PostDate)values"
        Sql = Sql & "(2,'" & UserName.Text.Replace("'", "&#39;") & "','" & CompanyName.Text.Replace("'", "&#39;") & "','" & Phone.Text.Replace("'", "&#39;") & "','" & Fax.Text.Replace("'", "&#39;") & "'"
