<%@ Page Language="VB" AutoEventWireup="false" CodeFile="inquiry.aspx.vb" Inherits="English_inquiry" %>
    ...
    <asp:Panel ID="show1" runat="server">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>
		  <div class="t12_3">Inquiry Cart</div>
		  <asp:Panel ID="ShowStatus1" runat="server">
		  <div id="line_3_1"><img src="images/line_4.jpg" alt="" width="510" height="1"></div>		  
		  <div id="line_6" style="display:"><div class="c_3_1">You have not selected any product!</div></div>
		  </asp:Panel>
          ...
          <asp:GridView id="GridView1" width="500px" border="1" cellpadding="0" cellspacing="2" bordercolor="#BDE3FF" CssClass="c_3" runat="server" DataSourceID="Sds_Data" DataKeyNames="PublicID" AutoGenerateColumns="False"><Columns>
               ...
               <asp:Button ID="BtnDel" runat="server" class="b_2" Text="Delete" CommandName="DelData" />
               </ItemTemplate>
		  ...
		  <div>
		  <div align="center">
          <asp:Button ID="BtnEdit" runat="server" class="b_1" Text="Submit" />&nbsp;&nbsp;&nbsp;&nbsp;
		  <asp:Button ID="BtnDel" runat="server" class="b_1" Text="Delete All" />&nbsp;&nbsp;&nbsp;&nbsp;
		  <asp:Button ID="BtnGoProduct" runat="server" class="b_1" Text="Add Other products" />		  
		  </div>
		  </div>
		  </td>
