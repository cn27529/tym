<%@ Page Language="VB" AutoEventWireup="false" CodeFile="product_search.aspx.vb" Inherits="product_search" %>
...
<head runat="server">
<title>鑫梅企業股份有限公司>>查詢結果</title>
<META NAME="KEYWORDS" CONTENT="鑫梅企業股份有限公司,產品搜尋" />
  ...
  <tr>
    ...
    <td width="616" valign="top" bgcolor="#BDE3FF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="images/line_2.jpg"><div class="t12_2">‧首頁 > <a href="product_search.aspx">產品搜尋</a></div></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td><div class="t12_3">搜尋結果： <span class="m_4"><asp:Literal ID="LitS" runat="server"></asp:Literal></span></div>
