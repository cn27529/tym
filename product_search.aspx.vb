...
Partial Class product_search
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request("S") <> "" Then
            ShowData()
        Else
            LitS.Text = "  <div><font color=red>請輸入關鍵字</font></div>"
        End If
        Session("T") = 5
    End Sub
    Private Sub ShowData()
        Dim sql As String
        sql = "select PublicID,Subject,Kind,ProductName,ProductNo,ProductSubject,ProductYear,ProductCar from Product where IsDel=false and Isonline=true and SiteID=1 "
        If Request("K") <> "" Then
        ...
        '這裡是分頁的
        If list = "" Then
            LitHtml.Text = "  <div align=""center""><font color=red>查無此資料</font></div>"
            LitPage.Text = ""
        Else
