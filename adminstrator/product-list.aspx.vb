...
#Region "GridView1"
    ...
    Private Sub GridViewProcess()
        ...
        sql = sql & " where IsDel=false "
        If TxtS.Text = "" Then
            sql = sql & " and ParentPublicID=" & ParentPublicID & ""
        Else
            sql = sql & " and ProductNo like '%" & TxtS.Text & "%'"
        End If
...
#Region "GridView2"
    ...
    Private Sub GridViewProcess2()
        ...
        End If
        Dim sql As String
        sql = "select ParentPublicID,PublicID,Subject,OrderData,Kind,ProductName from Product where IsDel=false and ParentPublicID=" & ParentPublicID & ""        
        sql = sql & " order by OrderData"
...
#End Region
    ...
    Protected Sub BtnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSearch.Click
        If TxtS.Text = "" Then
            Misc.AlertMsg(Page, "請輸入至少輸入一個搜尋的條件")
            Exit Sub
        End If
        GridViewProcess()
        ShowProcess(1)
