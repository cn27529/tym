...
Partial Class product
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("PID") <> "" Then
            ...
            Dim L As Integer
            Sql = "select PublicID,lvl from Product where IsDel=false and Isonline=true and SiteID=1 and PublicID=" & Request("PID") & ""
            ...
            dr.Close()
            If Chk = False Then
                Response.Write("<script>alert('無此資料');location.href='product.aspx';</script>")
                Response.End()
            End If
        ...
        Dim PID As Integer
        If Request("PID") = "" Then
            Sql = "select top 1 PublicID from Product where IsDel=false and Isonline=true and SiteID=1 and ParentPublicID=0 order by OrderData"
            dr = ClassDB.GetDataReader(Sql)
            If dr.Read Then
        ...
        End If
        If PID = 0 Then
            Response.Write("<script>alert('目前暫無任何產品資訊');location.href='aboutus.aspx';</script>")
            Response.End()
        Else
            ...
            If dr.Read Then
                ...
                If dr("Kind") = 1 Then
                    ...
                    If dr("FID2") = 0 Then
                        LitFileBig.Text = "<img src=""images/bigpic_1.jpg"" alt=""圖片製作中"" width=""500"" border=""0"">"
        ...
        ElseIf K = 3 Then
            ShowData3(PID)
        End If
        LitMeta.Text = "<META NAME=""KEYWORDS"" CONTENT=""鑫梅企業股份有限公司,產品介紹," & MetaData & """>" & vbCrLf
    End Sub
...
#Region "得到開頭"
    Function GetTitle(ByVal PublicID As Integer) As String
        Dim dr As OleDbDataReader = ClassDB.GetDataReader("select Subject,ProductName,Kind from  Product where IsDel=false and Isonline=true and SiteID=1 and PublicID=" & PublicID & "")
        Dim R As String
        If dr.Read Then
            If dr("Kind") = 1 Then
...
#End Region
    ...
    Private Sub ShowData1(ByVal PublicID As Integer)
        Dim sql As String
        sql = "select PublicID,Subject,Kind,ProductName,FID1,FID3 from Product where IsDel=false and Isonline=true and SiteID=1 "
        ...
        For i = SData To EData - 1
            ...
            list += "</div>" & vbCrLf
            If myTable.Rows(i).Item("Kind").ToString = 1 Then
                list += "<div class=""t12_4""><a href=""?PID=" & myTable.Rows(i).Item("PublicID").ToString & """>" & myTable.Rows(i).Item("Subject").ToString & "</a></div>" & vbCrLf
            Else
                list += "<div class=""t12_4""><a href=""?PID=" & myTable.Rows(i).Item("PublicID").ToString & """>" & myTable.Rows(i).Item("ProductName").ToString & "</a></div>" & vbCrLf
            End If
            list += "</div>" & vbCrLf
        ...
        If list = "" Then
            ...
            list += "<span class=""c_3_2"">目前暫無任何資料！</span>" & vbCrLf
            ...
            LitPage.Text = ""
        Else
            LitPage.Text = Page_VB(k, page, Pages, FromPage, ToPage, Curpage)
        End If
    End Sub
    Private Sub ShowData2(ByVal PublicID As Integer)
        Dim sql As String
        sql = "select PublicID,Subject,Kind,ProductName,FID3,content1 from Product where IsDel=false and Isonline=true and SiteID=1 "
        ...
        For i = SData To EData - 1
            ...
            list += "<div class=""c_1"">" & Left(myTable.Rows(i).Item("Content1").ToString, 50) & "...</div>" & vbCrLf
        ...
        If list = "" Then
            ...
            LitPage2.Text = ""
        Else
            LitPage2.Text = Page_VB(k, page, Pages, FromPage, ToPage, Curpage)
        End If
    End Sub
    Private Sub ShowData3(ByVal PublicID As Integer)
        Dim sql As String
        sql = "select * from Product where IsDel=false and Isonline=true and SiteID=1 and PublicID=" & PublicID & ""
        Dim ParentPublicID As Integer
        ...
        If dr.Read Then
            'LitCheck.Text = "<input name=""AddOrderData"" onclick=""AddOrder('" & dr("PublicID").ToString & "')"" type=""checkbox"" value=""""><span class=""c_3_2"">加入詢價清單</span>"
            ...
            If dr("ProductNo").ToString <> "" Then
                LitProductNo.Text = "<div class=""h_3""><strong>料&nbsp;&nbsp;&nbsp;號:</strong> " & dr("ProductNo").ToString & "</div>" & vbCrLf
                LitProductNo.Text += ShowStr & vbCrLf
            End If
            LitProductName.Text = "<div class=""h_3""><strong>品&nbsp;&nbsp;&nbsp;名:</strong> " & dr("ProductName").ToString & "" & vbCrLf
            If dr("ProductENName").ToString <> "" Then
                LitProductENName.Text = "&nbsp;&nbsp;" & dr("ProductENName").ToString & "</div>" & vbCrLf
            ...
            If dr("ProductCar").ToString <> "" Then
                LitProductCar.Text = "<div class=""h_3""><strong>車&nbsp;&nbsp;&nbsp;型:</strong> " & dr("ProductCar").ToString & "" & vbCrLf
                LitProductCar.Text += Url4 & vbCrLf
            End If
            If dr("ProductSubject").ToString <> "" Then
                LitProductSubject.Text = "<div class=""h_3""><strong>廠&nbsp;&nbsp;&nbsp;牌:</strong> " & dr("ProductSubject").ToString & "</div>" & vbCrLf
            End If
            If dr("Q1") <> 0 Then
            ...
            If dr("Content1").ToString <> "" Then
                ...
                LitContent1.Text += "<div class=""h_3""><strong>產品說明:</strong> </div>" & vbCrLf
            ...
            If dr("Content2").ToString <> "" Then
                ...
                LitContent2.Text += "<div class=""h_3""><strong>備註:</strong> </div>" & vbCrLf
            ...
            End If
            If Url5 <> "" Then
                LitImg.Text = "<div id=""bupic_1""><a href=""#""><img src=""images/bupic_1.jpg"" alt=""點選圖片放大"" width=""100"" height=""26"" border=""0"" onClick=""MM_openBrWindow('" & Url5 & "','','resizable=yes,width=760,height=570')""></a></div>"
            Else
                LitImg.Text = ""
            End If
            If dr("FID4") <> 0 Then
            ...
            If Url4 <> "" Then
                If Url5 <> "" Then
                    LitImg2.Text = "<div id=""pic_3""><a href=""#""><img src=""" & Url4 & """ alt=""點選圖片放大"" width=""400"" border=""0"" onClick=""MM_openBrWindow('" & Url5 & "','','resizable=yes,width=760,height=570')""></a></div>"
                Else
                    LitImg2.Text = "<div id=""pic_3""><img src=""" & Url4 & """ alt=""點選圖片放大"" width=""400"" border=""0""></div>"
                End If
            Else
                LitImg2.Text = ""
            End If
            If dr("FID6") <> 0 Then
                ...
                If dr2.Read Then
                    LitFileDown.Text = " <div class=""h_3"" style=""display:""><strong>圖解說明： </strong><a href=""" & UploadPath.Replace("~", "..") & dr2("FilePath") & dr2("FileName") & """ target=""_blank"">" & dr("FileTitle") & "</a></div>" & vbCrLf
                End If
                dr2.Close()
            End If
        End If
    ...
    Function GetCheck(ByVal PublicID As Integer) As String
        Dim R As String
        If Session("OrderData") = Nothing Then
            R = "<input name=""AddOrderData"" onclick=""AddOrder('" & PublicID & "')"" type=""checkbox"" value=""""><span class=""c_3_2"">加入詢價清單</span>"
        Else
            Dim ArrOrderData() As String = Session("OrderData").ToString.Split(",")
            Dim i As Integer
            Dim Chk As Boolean = False
            ...
            Next
            If Chk = True Then
                R = "<input name=""EscOrderData"" onclick=""EscOrder('" & PublicID & "')"" type=""checkbox"" checked value=""""><span class=""c_3_2"">加入詢價清單</span>"
            Else
                R = "<input name=""AddOrderData"" onclick=""AddOrder('" & PublicID & "')"" type=""checkbox"" value=""""><span class=""c_3_2"">加入詢價清單</span>"
            End If
        End If
